...
const Comments = ({ comment, setComment, addComment, comments, isPostingComment }: IProps) => {
  ...
  return (
    <div className='border-t-2 border-gray-200 pt-4 px-10 mt-4 bg-[#121212] border-b-2 lg:pb-0 pb-[100px]'>
     ...
     {userProfile && <div className='absolute bottom-0 left-0  pb-6 px-2 md:px-10 '>
        <form onSubmit={addComment} className='flex gap-4'>
          <input
            ...
            className='bg-primary text-white px-6 py-4 text-md font-medium border-2 w-[250px] md:w-[700px] lg:w-[350px] border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300 flex-1 rounded-lg'
